...
class JobEventProducer:
    ...
    async def start(self) -> None:
        ...
        self.logger.info(f"Started Kafka producer connected to {self.config.bootstrap_servers}")
...
class JobStatusProducer:
    ...
    async def start(self) -> None:
        ...
        await self.producer.start()
        self.logger.info(f"Started Kafka status producer connected to {self.config.bootstrap_servers}")
    ...
    async def publish_status(self, job_id: str, status: str, result: Optional[List[int]] = None, error: Optional[str] = None) -> None:
...
class JobStatusConsumer:
    ...
    async def start(self) -> None:
        ...
        await self.consumer.start()
        self.logger.info(f"Started Kafka status consumer for topic {self.config.status_topic}")
