...
@pytest.mark.asyncio
async def test_quicksort_empty_list():
...
@pytest.mark.asyncio
async def test_quicksort_single_element():
...
@pytest.mark.asyncio
async def test_quicksort_multiple_elements():
...
@pytest.mark.asyncio
async def test_quicksort_already_sorted():
...
@pytest.mark.asyncio
async def test_quicksort_reverse_sorted():
...
@pytest.mark.asyncio
async def test_quicksort_duplicates():
